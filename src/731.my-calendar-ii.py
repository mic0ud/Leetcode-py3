...
if __name__ == '__main__':
    s = MyCalendarTwo()
    res = []
    res.append(s.book(10,20))
    res.append(s.book(50,60))
    res.append(s.book(10,40))
    res.append(s.book(5,15))
    res.append(s.book(5,10))
    res.append(s.book(25,55))
    print(res)
